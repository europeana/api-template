 ...
 * 'Whitelabel' error page. This page will return the same json response for all content types.
 */
@RestController
public class ApiErrorController extends AbstractErrorController {

    private final ApiErrorAttributes errorAttributes;
     ...
     */
    @Autowired
    public ApiErrorController(ApiErrorAttributes errorAttributes) {
