...
class MyApiControllerTest {
    ...
    @Test
    void testMyControllerValidInput() throws Exception {
        // with accept header
    ...
    @Test
    void testMyControllerInvalidInput() throws Exception {
    ...
    @Test
    void testMyControllerCustomError() throws Exception {
    ...
    @Test
    void testMyControllerNotFoundError() throws Exception {
